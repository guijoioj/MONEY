...
**Repository:** Desktop
**File:** `frontend/src/pages/Produtos.jsx`
**Language:** `jsx`
...
Arquivo `frontend/src/pages/Produtos.jsx` do repositório Desktop.
              ...
              {data?.data?.data?.length === 0 ? (
                ...
                data?.data?.data?.map((produto) => (
                  <tr key={produto.id} className={`hover:bg-gray-50 ${!produto.ativo ? 'opacity-60' : ''}`}>
                    ...
                    <td className="px-6 py-4 text-gray-600">{formatCurrency(produto.precoCusto)}</td>
