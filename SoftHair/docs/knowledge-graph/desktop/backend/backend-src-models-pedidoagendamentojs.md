# backend/src/models/PedidoAgendamento.js

**Repository:** Desktop
**File:** `backend/src/models/PedidoAgendamento.js`
**Language:** `javascript`
...
Arquivo `backend/src/models/PedidoAgendamento.js` do repositório Desktop.
