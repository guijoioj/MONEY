# backend/src/services/securityInitService.js

**Repository:** Desktop
**File:** `backend/src/services/securityInitService.js`
**Language:** `javascript`
...
Arquivo `backend/src/services/securityInitService.js` do repositório Desktop.
