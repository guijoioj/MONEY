...
export default function Layout() {
  ...
  const ALL_ITEMS = [
    ...
    { to: '/fechamento',           icon: ClipboardCheck,  label: 'Atendimentos',        roles: ['admin', 'recepcao'] },
    ...
    { to: '/relatorios-comerciais',icon: BarChart3,       label: 'Painel comercial',    roles: ['admin'] },
    { to: '/backup',               icon: Database,        label: 'Backup',              roles: ['admin'] },
    { to: '/backups',              icon: Database,        label: 'Backups (auto)',      roles: ['admin'] },
    { to: '/auditoria',            icon: Database,        label: 'Auditoria',           roles: ['admin'] },
